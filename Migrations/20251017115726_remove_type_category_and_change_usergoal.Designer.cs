...
namespace ECM_BE.Migrations
{
    ...
    [Migration("20251017115726_remove_type_category_and_change_usergoal")]
    partial class remove_type_category_and_change_usergoal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryUserGoal", b =>
                {
                    ...
                    b.HasKey("CategoriesCategoryID", "CategoryID");

                    b.ToTable("CategoryUserGoal");
                });
            ...
            modelBuilder.Entity("UserGoalsCategories", b =>
                {
                    b.Property<int>("UserGoalID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserGoalID", "CategoryID");

                    b.HasIndex("CategoryID");

                    b.ToTable("UserGoalsCategories", (string)null);
                });
            ...
            modelBuilder.Entity("UserGoalsCategories", b =>
                {
                    ...
                    b.HasOne("ECM_BE.Models.Entities.UserGoal", null)
                        .WithMany()
